    ...
    <div
        ...
        <div style="display: flex;gap: 6px;">
            <p style="margin-bottom: 0px; font-size: 14px;font-weight: 500;margin-top: 0px;"><span
                    style="color: #878a99 !important;">Booking ID:</span> {{ $bookings->unique_booking_id }}</p>
            <p style="margin-bottom: 0px; font-size: 14px;font-weight: 500;margin-top: 0px;"><span
    ...
    <div style="padding: 1.5rem; background-color: #a9cf82; text-align: left;">
        ...
        <div style="padding: 1.5rem; background-color: #fff; text-align: left; border-radius: 10px;">
            <h5
                ...
                {{ $bookings->origin }} To {{ $bookings->destination }} </h5>
                    ...
                    <tr>
                        ...
                        <td colspan="2"
                            ...
                            <div
                                ...
                                <img src="{{ isset($airlineData) && isset($airlineData['AirLineLogo']) ? $airlineData['AirLineLogo'] : '' }}"
                                    alt="" height="38">
                            ...
                            <h6
                                ...
                                {{ isset($airlineData) ? $airlineData['AirLineName'] : '' }}</h6>
                            <p
                                style="color: #878a99 !important; margin-bottom: 0px; font-size: 13px;font-weight: 500;margin-top: 6px;">
                                {{ $flights->flight_number }}</p>
                            <p
                                style="color: #878a99 !important; margin-bottom: 0px; font-size: 13px;font-weight: 500;margin-top: 6px;">
                                Duration : {{ convertToHoursMins($flights->journey_duration) }}</p>
                            <p
                                style="padding: 10px; color: #fff !important; text-align: center; margin-bottom: 0px; font-size: 13px;font-weight: 500;margin-top: 6px; background-color: #1a7971;">
                                PNR : {{ $airlinePNR }}</p>
                        </td>
                        ...
                        <td style="padding: 15px 10px; vertical-align: middle; border: 1px solid #eee;">
                            ...
                            <hr>
                            <p
                                style="color: #333 !important; margin-bottom: 10px; font-size: 13px;font-weight: 500;margin-top: 6px;">
                                {{ $deptAirportData['AirportName'] }} Terminal {{ $flights->departure_terminal }}
                            </p>
                        </td>
                        ...
                        <td style="padding: 15px 10px; vertical-align: middle; border: 1px solid #eee;">
                            ...
                            <p
                                style="color: #333 !important; margin-bottom: 10px; font-size: 13px;font-weight: 500;margin-top: 6px;">
                                {{ $arrAirportData['AirportName'] }} Terminal ({{ $flights->arrival_terminal }})
                            </p>
                        </td>
                    </tr>
                @endforeach
            ...
            <tr>
                ...
                <td colspan="2" style="padding: 12px 8px; font-size: 15px;text-align: end; ">
                    <h6 style="font-size: 15px; margin: 0px;font-weight: 600; font-family: 'Poppins', sans-serif;">
                        {{ $bookings->currency }}
                        {{ $bookings->adult_amount + $bookings->child_amount + $bookings->infant_amount }}</h6>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="padding: 12px 8px; font-size: 15px;">
                ...
                <td colspan="2" style="padding: 12px 8px; font-size: 15px;text-align: end; ">
                    <h6 style="font-size: 15px; margin: 0px;font-weight: 600; font-family: 'Poppins', sans-serif;">
                        {{ $bookings->currency }} {{ $bookings->total_tax }}</h6>
                </td>
            </tr>
            @if ($bookings->addon_amount != 0)
                <tr>
                    <td colspan="2" style="padding: 12px 8px; font-size: 15px;">
                        Add Ons
                    </td>
                    <td colspan="2" style="padding: 12px 8px; font-size: 15px;text-align: end; ">
                        <h6 style="font-size: 15px; margin: 0px;font-weight: 600; font-family: 'Poppins', sans-serif;">
                            {{ $bookings->currency }} {{ $bookings->addon_amount }}</h6>
                    </td>
                </tr>
            @endif
            <tr>
                ...
                <td colspan="2" style="padding: 12px 8px; font-size: 15px;text-align: end; ">
                    <h6 style="font-size: 15px; margin: 0px;font-weight: 600; font-family: 'Poppins', sans-serif;">
                        {{ $bookings->currency }} {{ $bookings->total_amount }} </h6>
                    </th>
            </tr>
                ...
                <tr>
                    <td colspan="4" style="padding: 12px 8px; font-size: 15px;border-top: 1px solid #e9ebec;">
                        <div style="padding: 1.5rem; background-color: #eee; text-align: left; border-radius: 10px;">
                            <p style="color: #333 !important; margin-bottom: 0px;margin-top: 0px;">TRAVELLER
                                ({{ $pass->passenger_type == 'ADT' ? 'Adult' : ($pass->passenger_type == 'CHD' ? 'Child' : 'Infant') }})
                                - <span
                                    style="color: #1fba71;font-weight: 600;">{{ $pass->is_return == 0 ? 'Onward Trip' : 'Return Trip' }}</span>
                            </p>
                            <h5
                                style="font-size: 18px;font-family: 'Poppins', sans-serif;font-weight: 600;margin-bottom: 0px;margin-top: 0px;line-height: 1.2;color: #1a7971 !important;">
                                {{ $pass->passenger_first_name }} {{ $pass->passenger_last_name }} <span
                                    style="font-size: 13px; color: #333;"></span>
                            </h5>

                            <p style="color: #333 !important; margin-bottom: 5px;margin-top: 5px;">E-TICKET NO:
                                {{ $pass->eticket_number }}
                            </p>
                        </div>
                    </td>
