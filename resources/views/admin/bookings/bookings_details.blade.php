        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h3 class="bold float-left">
                                {{ $bookings[0]->direction == 'OneWay' ? 'One Way' : ($bookings[0]->direction == 'Return' ? 'Round' : 'Multi City') }}
                                Trip from {{ $bookings[0]->origin }} to {{ $bookings[0]->destination }} <small
                                    class="bold"> &nbsp; &nbsp; Booked by {{ $bookings[0]->agent_name }} (Booking Id :
                                    {{ $bookings[0]->unique_booking_id }})</small></h3>
                            <!-- <a href="{{ route('agent.create') }}" class="btn back-btn" ><i class="fa fa-plus"></i> Create Agent</a> -->
                            <button class="btn back-btn" onclick="history.go(-1)"><i class="fa fa-long-arrow-left"></i>
                                Back</button>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                                                                        ...
                                                                        <div class="fb-cb">
                                                                            @if (isset($bookings[0]))
                                                                                @foreach ($bookings[0]['flights'] as $flights)
                                                                                    ...
                                                                                    @endphp
                                                                                    <div
                                                                                        class="row y-gap-10 justify-between">
                                                                                        <div class="col-auto">
                                                                                            <div
                                                                                            ...
                                                                                            <div class="relative z-0">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    @if ($flights->journey_duration)
                                                                                                        @if ($bookings[0]->api_provider == 'flydubai')
                                                                                                            <div
                                                                                                                class="text-14 text-light-1">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    @if (!empty($bookings[0]['extraServices']))
                                                                                        ...
                                                                                        <div class=" mt-1 col-sm-12"
                                                                                            ...
                                                                                            <div class="">
                                                                                                <div
                                                                                                    class="tour_details_right_box_heading">
                                                                                                    <h3>Extra Services</h3>
                                                                                                </div>

                                                                                                <div
                                                                                                    class="tour_booking_amount_area">
                                                                                                    <ul>
