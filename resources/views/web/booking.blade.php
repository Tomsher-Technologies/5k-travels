                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text text-dark">
                        @if ($data['search_type'] == 'OneWay' && Session::has('flight_search_oneway'))
                            <h2>Your trip to {{ $data['airports'][session('flight_search_oneway')['oTo']]['City'] }} <img
                                    src="{{ asset('assets/img/icon/flight.png') }}" alt=""></h2>
                        @elseif($data['search_type'] == 'Return' && Session::has('flight_search_return'))
                            <h2>Your trip to {{ $data['airports'][session('flight_search_return')['rTo']]['City'] }} and
                                        ...
                                        @foreach ($data['flightsOutgoing'] as $outGoing)
                                            ...
                                            <div class="py-20 px-30">
                                                <div class="row justify-between items-center">
                                                    <div class="col-auto">
                                                        <div class="fw-500 text-dark-1">Depart •
                                                            {{ date('d M, Y', strtotime($outGoingFLightSegment['DepartureDateTime'])) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="text-14 text-light-1">Duration:
                                                    ...
                                                    @endif
                                                    <div class="col-auto">
                                                        <div class="text-14 text-light-1">Cabin Class: {{ $cabinClass }}
                                                ...
                                                <div class="row y-gap-10 justify-between">
                                                    <div class="col-auto col-sm-8">
                                                        <div class="d-flex items-center mb-15">
                                                            <div class="w-28 d-flex justify-center mr-15"><img
                                                                    src="{{ isset($airlineData[0]) ? $airlineData[0]['AirLineLogo'] : '' }}"
                                                                    alt="image"></div>
                                                            <div class="text-14 text-light-1">
                                                                {{ isset($airlineData[0]) ? $airlineData[0]['AirLineName'] : '' }}
                                                                {{ $airlineCode }} |
                                                                {{ $outGoingFLightSegment['FlightNumber'] }}
                                                        ...
                                                        <div class="relative z-0">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="lh-14 fw-500">
                                                                            {{ date('H:i', strtotime($outGoingFLightSegment['DepartureDateTime'])) }}
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="lh-14 fw-500">
                                                            ...
                                                            <div class="d-flex items-center  mt-3 mb-3">
                                                                <div class="w-28 d-flex justify-center mr-15"><img
                                                                        src="{{ asset('assets/img/icon/plane.svg') }}"
                                                                        alt="image">
                                                                </div>
                                                            ...
                                                            <div class="d-flex items-center mt-15">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <div class="lh-14 fw-500">
                                                                            {{ date('H:i', strtotime($outGoingFLightSegment['ArrivalDateTime'])) }}
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="lh-14 fw-500">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="makeFlex spaceBetween appendBottom3 fontSize14">
                                                            <span class=" col-sm-4 baggageInfoText blackFont">BAGGAGE :
                                                            </span>
                                                            <span
                                                                class=" col-sm-4 baggageInfoText blackFont text-center">CHECK
                                                                IN</span>
                                                            <span
                                                                class=" col-sm-4 baggageInfoText blackFont text-center">CABIN</span>
                                                        </div>
                                                        ...
                                                        @if (array_key_exists($bagKey, $data['flightBaggageOut']))
                                                            ...
                                                            @foreach ($flightBagOutKey as $bagKeys => $bagData)
                                                                <div class="makeFlex spaceBetween appendBottom3 fontSize14">
                                                                    <span class="baggageInfoText darkText col-sm-4">
                                                                        {{ $bagKeys == 'ADT' ? 'Adult' : ($bagKeys == 'CHD' ? 'Child' : 'Infant') }}
                                                                    </span>
                                                                    <span
                                                                        class="baggageInfoText darkText col-sm-4 text-center">{{ $bagData['baggage'] != '' ? $bagData['baggage'] : '-' }}</span>
                                                                    <span
                                                                        class="baggageInfoText darkText col-sm-4 text-center">{{ $bagData['cabin_baggage'] != '' ? $bagData['cabin_baggage'] : '-' }}</span>
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                    </div>
                                                        ...
                                                        <div class="flightLayoverOuter">
                                                            <div class="flightLayover mmtConnectLayover">
                                                                <div class="makeFlex fontSize14">
                                                                    <p> <span style="color: #5d8f3a;">Change of
                                                                            planes</span>
                                                                        <b>{{ convertToHoursMins($data['layovers'][$outArrAirCode]) }}</b>
                                                                        Layover in
                                                                        {{ isset($data['airports'][$outArrAirCode]) ? $data['airports'][$outArrAirCode]['City'] : $outArrAirCode }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            @if (isset($data['flightsIncoming']))
                                                ...
                                                @foreach ($flightsIncoming as $inComing)
                                                    @php
                                                        ...
                                                        $inDepAirCode =
                                                            $incomingFlightSegment['DepartureAirportLocationCode'];
                                                        $deptAirportDataIn = getAirportData($inDepAirCode);

                                                        $inArrAirCode =
                                                            $incomingFlightSegment['ArrivalAirportLocationCode'];
                                                    ...
                                                    <div class="py-20 px-30">
                                                        <div class="row justify-between items-center">
                                                            <div class="col-auto">
                                                                <div class="fw-500 text-dark-1">Depart •
                                                                    {{ date('d M, Y', strtotime($incomingFlightSegment['DepartureDateTime'])) }}
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="text-14 text-light-1">Duration:
                                                            ...
                                                            @endif
                                                            <div class="col-auto">
                                                                <div class="text-14 text-light-1">Cabin Class:
                                                                    {{ $cabinClass }}
                                                    ...
                                                    <div class="py-30 px-30 border-top-light">
                                                        <div class="row y-gap-10 justify-between">
                                                            <div class="col-auto col-sm-8">
                                                                <div class="d-flex items-center mb-15">
                                                                    <div class="w-28 d-flex justify-center mr-15"><img
                                                                            src="{{ isset($airlineDataIn[0]) ? $airlineDataIn[0]['AirLineLogo'] : '' }}"
                                                                            alt="image"></div>
                                                                    <div class="text-14 text-light-1">
                                                                        {{ isset($airlineDataIn[0]) ? $airlineDataIn[0]['AirLineName'] : '' }}
                                                                        {{ $airlineCodeIn }} |
                                                                        {{ $incomingFlightSegment['FlightNumber'] }}
                                                                ...
                                                                <div class="relative z-0">
                                                                    ...
                                                                    <div class="d-flex items-center">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-auto">
                                                                                <div class="lh-14 fw-500">
                                                                                    {{ date('H:i', strtotime($incomingFlightSegment['DepartureDateTime'])) }}
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-auto">
                                                                                <div class="lh-14 fw-500">
                                                                                    {{ $deptAirportDataIn[0]['AirportName'] }}
                                                                                    ({{ $inDepAirCode }})</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex items-center mt-15">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-auto">
                                                                                <div class="lh-14 fw-500">
                                                                                    {{ date('H:i', strtotime($incomingFlightSegment['ArrivalDateTime'])) }}
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-auto">
                                                                                <div class="lh-14 fw-500">
                                                                                    {{ $arrAirportDataIn[0]['AirportName'] }}
                                                                                    ({{ $inArrAirCode }})</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div
                                                                    class="makeFlex spaceBetween appendBottom3 fontSize14">
                                                                    <span
                                                                        class=" col-sm-4 baggageInfoText blackFont">BAGGAGE
                                                                        : </span>
                                                                    <span
                                                                        class=" col-sm-4 baggageInfoText blackFont text-center">CHECK
                                                                        IN</span>
                                                                ...
                                                                @if (array_key_exists($bagKey, $data['flightBaggageIn']))
                                                                    ...
                                                                    @foreach ($flightBagInKey as $bagKey2 => $bagData)
                                                                        <div
                                                                            class="makeFlex spaceBetween appendBottom3 fontSize14">
                                                                            <span
                                                                                class="baggageInfoText darkText col-sm-4">
                                                                                {{ $bagKey2 == 'ADT' ? 'Adult' : ($bagKey2 == 'CHD' ? 'Child' : 'Infant') }}
                                                                            </span>
                                                                            <span
                                                                                class="baggageInfoText darkText col-sm-4 text-center">{{ $bagData['baggage'] != '' ? $bagData['baggage'] : '-' }}</span>
                                                                            <span
                                                                ...
                                                                <div class="flightLayoverOuter">
                                                                    <div class="flightLayover mmtConnectLayover">
                                                                        <div class="makeFlex fontSize14">
                                                                            <p> <span style="color: #5d8f3a;">Change of
                                                                                    planes</span>
                                                                                <b>{{ convertToHoursMins($data['layoversIn'][$inArrAirCode]) }}</b>
                                                                                Layover in
                                                                                {{ $arrAirportDataIn[0]['City'] }}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endif
                                    ...
                                    @else
                                        @foreach ($data['flightsOutgoing'] as $outGoing)
                                            ...
                                            <div class="py-10">
                                                ...
                                                @php
                                                    $outDepAirCode =
                                                        $outGoingFLightSegment['DepartureAirportLocationCode'];
                                                    $deptAirportData = getAirportData($outDepAirCode);

                                                    $outArrAirCode =
                                                        $outGoingFLightSegment['ArrivalAirportLocationCode'];
                                                    $arrAirportData = getAirportData($outArrAirCode);
                            ...
                            @php
                                ...
                                if (isset($data['FareBreakdownIn'])) {
                                    foreach ($data['FareBreakdownIn'] as $fkeyIn => $fvalueIn) {
                                        ...
                                        $fareBaseMarginIn = number_format(
                                            floor($fareBaseMarginIn * 100) / 100,
                                            2,
                                            '.',
                                            '',
                                        );
                                ...
                                if (isset($data['ItinTotalFaresIn'])) {
                                    ...
                                    $TotalFareMarginIn =
                                        ($TotalFareIn['Amount'] / 100) * $totalmargin + $TotalFareIn['Amount'];
                                    $TotalFareMarginIn = number_format(
                                        floor($TotalFareMarginIn * 100) / 100,
                                        2,
                                        '.',
                                        '',
                                    );
                                    ...
                                    $baseFareMarginIn =
                                        ($BaseFareIn['Amount'] / 100) * $totalmargin + $BaseFareIn['Amount'];
                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <input type="hidden" name="currency" id="currency"
                                            value="{{ $currencyCode }}">
                                        <input type="hidden" name="total_amount_org" id="total_amount_org"
                                            value="{{ $totalFareAmount }}">
                                        <input type="hidden" name="total_amount" id="total_amount"
                                            value="{{ $TotalFareMargin }}">
                                        <input type="hidden" name="total_tax" id="total_tax"
                                            value="{{ $taxFareMargin }}">
                                        <input type="hidden" name="total_tax_org" id="total_tax_org"
                                            value="{{ $TotalTax }}">
                                        <input type="hidden" name="adult_amount" id="adult_amount"
                                            value="{{ $adult_amount }}">
                                        <input type="hidden" name="child_amount" id="child_amount"
                                            value="{{ $child_amount }}">
                                        <input type="hidden" name="infant_amount" id="infant_amount"
                                            value="{{ $infant_amount }}">
                                    </div>
                                        ...
                                        <div class="tour_detail_right_sidebar">
                                            <div class="tour_details_right_boxed">
                                                ...
                                                <div class="tour_package_details_bar_list">
                                                    @php
                                                        $adultCount = isset($data['adultCount'])
                                                            ? $data['adultCount']
                                                            : 0;
                                                        $childCount = isset($data['childCount'])
                                                            ? $data['childCount']
                                                            : 0;
                                                        $infantCount = isset($data['infantCount'])
                                                            ? $data['infantCount']
                                                            : 0;
                                                    ...
                                                    @if (isset($data['extraBaggage']['outGoing']))
                                                        <h4 class="fareRule-heading"><i
                                                                class="fa fa-suitcase"></i>&nbsp;{{ $outFrom != '' && isset($data['airports'][$outFrom]) ? $data['airports'][$outFrom]['AirportName'] : $outFrom }}
                                                            ->
                                                            {{ $outTo != '' && isset($data['airports'][$outTo]) ? $data['airports'][$outTo]['AirportName'] : $outTo }}
                                                        </h4>
                                                        <table>
                                                            @php
                                                                $bout = 0;
                                                                $bagRestictOut = $bagRestict;
                                                                $extraBaggageOutGoing =
                                                                    $data['extraBaggage']['outGoing'];
                                                            @endphp
                                                            ...
                                                            @foreach ($extraBaggageOutGoing as $exBagOut)
                                                                ...
                                                                @php
                                                                    ...
                                                                    $exBagOutServiceServiceCost =
                                                                        $exBagOutService['ServiceCost'];
                                                                @endphp
                                                                <tr>
                                                                    <td>{{ $description }}
                                                                        {{ isset($desc[$exBagOutService['Behavior']]) ? $desc[$exBagOutService['Behavior']] : '' }}
                                                                    </td>
                                                                    <td>{{ $exBagOutServiceServiceCost['CurrencyCode'] }}
                                                                        {{ $exBagOutServiceServiceCost['Amount'] }} </td>
                                                                    <td class="text">
                                                                        <div class="d-flex">
                                                                            <button type="button"
                                                                                class="extraService bag_countOut f-7"
                                                                                id="minusBag"
                                                                                data-max="{{ $bagRestictOut }}"
                                                                                data-price="{{ $exBagOutServiceServiceCost['Amount'] }}"
                                                                                data-id="{{ $exBagOutService['ServiceId'] }}">
                                                                                <i class="fas fa-minus"></i>
                                                                            </button>
                                                                            <input type="text"
                                                                                name="baggageOut[{{ $exBagOutService['ServiceId'] }}][]"
                                                                                id="baggageOut" class="baggage_count"
                                                                                value="0">
                                                                            <button type="button"
                                                                                class=" extraService bag_countOut"
                                                                                data-max="{{ $bagRestictOut }}"
                                                                                data-price="{{ $exBagOutServiceServiceCost['Amount'] }}"
                                                                                data-id="{{ $exBagOutService['ServiceId'] }}"
                                                                                id="plusBag">
                                                    ...
                                                    @if (isset($data['extraBaggage']['inComing']))
                                                        <h4 class="fareRule-heading"><i
                                                                class="fa fa-suitcase"></i>&nbsp;{{ $inFrom != '' && isset($data['airports'][$inFrom]) ? $data['airports'][$inFrom]['AirportName'] : $inFrom }}
                                                            ->
                                                            {{ $inTo != '' && isset($data['airports'][$inTo]) ? $data['airports'][$inTo]['AirportName'] : $inTo }}
                                                        </h4>
                                                        <table>
                                                            @php
                                                                $bin = 0;
                                                                $bagRestictIn = $bagRestict;
                                                                $extraBaggageinComing =
                                                                    $data['extraBaggage']['inComing'];
                                                            @endphp
                                                            @foreach ($extraBaggageinComing as $exBagIn)
                                                                ...
                                                                @php
                                                                    if (
                                                                        $bin == 0 &&
                                                                        strpos($exBagInService['Behavior'], 'GROUP') !==
                                                                            false
                                                                    ) {
                                                                        $bagRestictIn = 1;
                                                                    }
                                                                ...
                                                                <tr>
                                                                    <td>{{ $description }}
                                                                        {{ isset($desc[$exBagInService['Behavior']]) ? $desc[$exBagInService['Behavior']] : '' }}
                                                                    </td>
                                                                    <td>{{ $exBagInService['ServiceCost']['CurrencyCode'] }}
                                                                        {{ $exBagInService['ServiceCost']['Amount'] }}
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <button type="button"
                                                                                class=" extraService bag_countIn f-7"
                                                                                id="minusBagIn"
                                                                                data-max="{{ $bagRestictIn }}"
                                                                                data-price="{{ $exBagInService['ServiceCost']['Amount'] }}"
                                                                                data-id="{{ $exBagInService['ServiceId'] }}">
                                                                                <i class="fas fa-minus"></i>
                                                                            </button>
                                                                            <input type="text"
                                                                                name="baggageIn[{{ $exBagInService['ServiceId'] }}][]"
                                                                                id="baggage" class="baggage_countIn"
                                                                                value="0">
                                                                            <button type="button"
                                                                                class=" extraService bag_countIn"
                                                                                data-max="{{ $bagRestictIn }}"
                                                                                data-price="{{ $exBagInService['ServiceCost']['Amount'] }}"
                                                                                data-id="{{ $exBagInService['ServiceId'] }}"
                                                                                id="plusBagIn">
                                                ...
                                                <div class="tour_package_details_bar_list">
                                                    @foreach ($data['fareRulesOut'] as $farerule)
                                                        @php
                                                            ...
                                                            $fromCity = $toCity = '';
                                                            $cityString =
                                                                isset($fareruleCityPair) && $fareruleCityPair != ''
                                                                    ? str_split($fareruleCityPair, 3)
                                                                    : '';
                                                            if ($cityString) {
                                                        ...
                                                        @if ($fromCity != '' && $toCity != '')
                                                            <h4 class="fareRule-heading"><i
                                                                    class="fa fa-plane"></i>&nbsp;{{ isset($data['airports'][$fromCity]) ? $data['airports'][$fromCity]['AirportName'] : $fromCity }}
                                                                ->
                                                                {{ isset($data['airports'][$toCity]) ? $data['airports'][$toCity]['AirportName'] : $toCity }}
                                                            </h4>
                                                        @endif
                                    ...
                                    <div class="booking_tour_form">
                                                    ...
                                                    <div class="row form_area">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control bg_input "
                                                                    id="adult_first_name{{ $passCount }}"
                                                                    name="adult_first_name[]" placeholder="First Name">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="last_name">Last Name<span
                                                                        class="required">*</span></label>
                                                                <input type="text" class="form-control bg_input"
                                                                    id="adult_last_name{{ $passCount }}"
                                                                    name="adult_last_name[]" placeholder="Last Name">
                                                                <div class="error-div"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label for="date">Date Of Birth<span
                                                                    class="required">*</span></label>
                                                            <input type="text"
                                                                class="form-control bg_input datepickerAdult" readonly
                                                                placeholder="YYYY-MM-DD" name="adult_dob[]"
                                                                id="datepickerAdult{{ $passCount }}" />
                                                            <div class="error-div"
                                                                id="adult_date_error{{ $passCount }}"></div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control appearance-auto"
                                                                    ...
                                                                    id="adult_nationality{{ $passCount }}"
                                                                    placeholder="MM">
                                                                    <option value=""> Select</option>
                                                                    {!! $countries !!}
                                                                </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label for="date">Passport Expiry<span
                                                                    class="required">*</span></label>
                                                            <input type="text"
                                                                class="form-control bg_input passportExpiry" readonly
                                                                placeholder="YYYY-MM-DD" name="adult_passport_expiry[]"
                                                    ...
                                                    <div class="row form_area">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label for="date">Date Of Birth<span
                                                                    class="required">*</span></label>
                                                            <input type="text"
                                                                class="form-control bg_input datepickerChild" readonly
                                                                placeholder="YYYY-MM-DD" name="child_dob[]"
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control appearance-auto"
                                                                    ...
                                                                    id="child_nationality{{ $passCount }}"
                                                                    placeholder="MM">
                                                                    <option value=""> Select</option>
                                                                    {!! $countries !!}
                                                                </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="text"
                                                                class="form-control bg_input passportExpiry" readonly
                                                                placeholder="YYYY-MM-DD" name="child_passport_expiry[]"
                                                                id="passportExpiry{{ $passCount }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row form_area">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label for="date">Date Of Birth<span
                                                                    class="required">*</span></label>
                                                            <input type="text"
                                                                id="datepickerInfant{{ $passCount }}" readonly
                                                                placeholder="YYYY-MM-DD"
                                                                class="form-control bg_input datepickerInfant"
                                                                name="infant_dob[]" />
                                                            <div class="error-div"></div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control appearance-auto"
                                                                    ...
                                                                    id="infant_nationality{{ $passCount }}"
                                                                    placeholder="MM">
                                                                    <option value=""> Select</option>
                                                                    {!! $countries !!}
                                                                </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="text"
                                                                class="form-control bg_input passportExpiry" readonly
                                                                placeholder="YYYY-MM-DD" name="infant_passport_expiry[]"
                                                                id="passportExpiry{{ $passCount }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tour_booking_form_box mt-3">
                                            ...
                                            <div class="row form_area">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="first_name">Mobile No<span
                                                                class="required">*</span></label>
                                                        <input type="text" class="form-control bg_input "
                                                            autocomplete="none" placeholder="Mobile No" name="mobile_no"
                                                            id="mobile_no">
                                                        <div class="error-div"></div>
                                        ...
                                        <div class="tour_booking_form_box mt-3">
                                            ...
                                            <input type="hidden" name="fare_source_code" id="fare_source_code"
                                                value="{{ $data['FareSourceCode'] }}">

                                            <input type="hidden" name="session_id" id="session_id"
                                                value="{{ $data['session_id'] }}">
                                            @if (isset($data['FareSourceCodeInbound']))
                                                <input type="hidden" name="fare_source_code_inbound"
                                                    id="fare_source_code_inbound"
                                                    value="{{ $data['FareSourceCodeInbound'] }}">
                                                <input type="hidden" name="direction" id="direction" value="Return">
                                            @else
                                                <input type="hidden" name="direction" id="direction"
                                                    value="{{ $data['search_type'] }}">
                                            @endif
                                            <input type="hidden" name="IsPassportMandatory" id="IsPassportMandatory"
                                                value="{{ $data['IsPassportMandatory'] == 1 || ($data['IsPassportMandatory'] == true || $data['IsPassportMandatory'] == 'true') ? 'true' : 'false' }}">
                                            <input type="hidden" name="FareType" id="FareType"
                                                value="{{ $data['FareType'] }}">
                                            ...
                                            @if (Auth::check())
                                                @php
                                                    ...
                                                    if ($currencyCode != 'USD') {
                                                        ...
                                                        $usdAmount = number_format(
                                                            $TotalFareMargin * $oneCurrency,
                                                            2,
                                                            '.',
                                                            '',
                                                        );
                                                ...
                                                @if ($balance >= $usdAmount)
                                                    <button type="submit" class="btn btn_theme btn_lg mt-30">Continue to
                                                        Payment</button>
                                                @else
                                                    <div class='alert alert-danger mt-3'
                                                        style="width: 300px;text-align: center;">Insufficient balance in
                                                        wallet. </div>
                                                @endif
                                            @else
                                                <button type="button" id="loginCheck"
                                                    class="btn btn_theme btn_lg mt-30">Continue to Payment</button>
                                            @endif
                                ...
                                <div class="tour_details_right_boxed">
                                    ...
                                    <div class="tour_booking_amount_area">
                                        ...
                                        <div class="tour_bokking_subtotal_area">
                                            <h6>Total Base Fare <span>{{ $currencyCode }} {{ $baseFareMargin }}</span>
                                            </h6>
                                        </div>
                                        <div class="tour_bokking_subtotal_area">
                                        ...
                                        <div class="total_subtotal_booking">
                                            <h4>Total Amount <span id="amountSpan">{{ $currencyCode }}
                                                    {{ $TotalFareMargin }}</span> </h4>
                                        </div>
                                        <!-- <hr>
                                        <div class="form-check write_spical_check mt-3">
...
@push('footer')
    <!-- SweetAlert -->
    <script src="{{ asset('assets/js/sweetalert.min.js') }}" crossorigin="anonymous" referrerpolicy="no-referrer">
    </script>
