                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            @endif
                            <br />
                            <form id="storeAgent" action="{{ route('yasin.routes.update', $route->id) }}" method="POST"
                                ...
                                <div class="item form-group col-md-12 col-sm-12" id="agentsDiv">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control select2" name="from_airport" id="from_airport" required>
                                            <option selected value="{{ $route->from }}">
                                                {{ $route->fromAirport->AirportCode }} -
                                                {{ $route->fromAirport->AirportName }}</option>
                                        </select>
                                        @error('from_airport')
                                ...
                                <div class="item form-group col-md-12 col-sm-12" id="agentsDiv">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control select2" name="to_airport" id="to_airport" required>
                                            <option selected value="{{ $route->to }}">
                                                {{ $route->toAirport->AirportCode }} - {{ $route->toAirport->AirportName }}
                                            </option>
                                        </select>
                                        @error('to_airport')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="item form-group col-md-12 col-sm-12" id="agentsDiv">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="1" {{ $route->status == 1 ? 'selected' : '' }}>Enabled
                                            </option>
                                            <option value="0" {{ $route->status == 0 ? 'selected' : '' }}>Disabled
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-danger">{{ $message }}</div>
