            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <ul class="topbar-list">
                        <li>
                            <a href="{{ $settings['facebook']['value'] }}" target="_blank"><i
                                    class="fab fa-facebook"></i></a>
                            <a href="{{ $settings['twitter']['value'] }}" target="_blank"><i
                                    class="fab fa-twitter-square"></i></a>
                            <a href="{{ $settings['instagram']['value'] }}" target="_blank"><i
                                    class="fab fa-instagram"></i></a>
                            <a href="{{ $settings['linkedin']['value'] }}" target="_blank"><i
                            ...
                            <li>
                                <div class="dropdown language-option">
                                    ...
                                    <div class="dropdown-menu language-dropdown-menu"
                                        ...
                                        <a class="dropdown-item {{ $currency == 'AED' ? 'selected' : '' }}"
                                            href="{{ route('change-currency', 'AED') }}">AED</a>
                                        <a class="dropdown-item {{ $currency == 'AFN' ? 'selected' : '' }}"
                                            href="{{ route('change-currency', 'AFN') }}">AFN</a>
                                        <a class="dropdown-item {{ $currency == 'INR' ? 'selected' : '' }}"
                                            href="{{ route('change-currency', 'INR') }}">INR</a>
                                        <a class="dropdown-item {{ $currency == 'IRR' ? 'selected' : '' }}"
                ...
                <div class="container">
                    <div class="option-inner">
                        <div class="others-options d-flex align-items-center">
                            ...
                            <div class="option-item">
                                <a href="#common_author-forms" data-bs-target="#common_author-forms"
                                    data-bs-toggle="modal" class="btn  btn_navber">LOGIN</a>
