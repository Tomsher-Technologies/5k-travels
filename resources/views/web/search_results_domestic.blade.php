                                        ...
                                        <div class="flight_search_item_wrappper">
                                            <div class="flight_search_items">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="flight_logo" style="display:flex; padding: 10px;">
                                                                ...
                                                                <div class="flight-details"
                                                                    ...
                                                                    <h4 id="depFlight{{ $loop->iteration }}">
                                                                        {{ isset($data['flightData'][$firstFlightSegmentAirlineCode]) ? $data['flightData'][$firstFlightSegmentAirlineCode]['AirLineName'] : '' }}
                                                                    </h4>
                                                        ...
                                                        <div class="col-lg-12"
                                                            ...
                                                            <div class=" col-lg-2 flight_search_middel">
                                                                <div class="flight_right_arrow">
                                                                    ...
                                                                    <p>{{ convertToHoursMins($fdata['totalDuration']) }}
                                                                    </p>
                                                ...
                                                <div class="flight_search_right" style="display:flex;">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <h3 class="bold"><span
                                                                id="depCurrency{{ $loop->iteration }}">{{ $totalFares['CurrencyCode'] }}</span>
                                                            <!-- {{ $fdata['TotalFares']['TotalFare']['Amount'] }}  -->
                                                            <span id="depAmount{{ $loop->iteration }}">
                                                                {{ $totalFareMargin }}</span>
                                                            <!-- <sup>*20% OFF</sup> -->
                                                        </h3>

                                                        <input type="hidden" value="{{ $fdata['FareSourceCode'] }}"
                                                            name="fare_code_dep_{{ $loop->iteration }}"
                                                            id="fare_code_dep_{{ $loop->iteration }}">

                                                        <!-- <p>*Discount applicable on some conditions</p> -->
                                                        <h6 data-id="{{ $loop->iteration }}" data-type="departure"
                                                            data-search_type="{{ $data['search_type'] }}"
                                                            data-session_id="{{ $data['session_id'] }}"
                                                            data-fareCode="{{ $fdata['FareSourceCode'] }}"
                                                            class="viewDomFlightDetails">View Details<i
                                                                class="fas fa-chevron-down"></i></h6>
                                                    </div>
                                                    <div class="col-lg-4" style="text-align: center;margin: auto;">
                                                        <input type="radio" class="bookOut"
                                                            value="{{ $loop->iteration }}"
                                                            @if ($loop->iteration == 1) checked @endif name="bookOut"
                                                            id="bookOut" class="col-form-control"
                                            ...
                                            <div class="flight_policy_refund collapse"
                                                id="detialsDomDepView_{{ $loop->iteration }}">
                                ...
                                @if ($data['flightDetailsInbound'])
                                    @foreach ($data['flightDetailsInbound'] as $fdataIn)
                                        @php
                                            ...
                                            $totalFareMarginIn = ($totalFaresIn['Amount'] / 100) * $totalmargin + $totalFaresIn['Amount'];
                                        ...
                                        <div class="flight_search_item_wrappper">
                                            <div class="flight_search_items">
                                                    ...
                                                    <div class="flight_multis_area_wrapper">
                                                        <div class="col-lg-12">
                                                            <div class="flight_logo" style="display:flex; padding: 10px;">
                                                                ...
                                                                <div class="flight-details"
                                                                    style="    margin-left: 10px;">
                                                                    <h4 id="returnFlight{{ $loop->iteration }}">
                                                                        {{ isset($data['flightData'][$firstFlightSegmentInAirlineCode]) ? $data['flightData'][$firstFlightSegmentInAirlineCode]['AirLineName'] : '' }}
                                                                    </h4>
                                                        ...
                                                        <div class="col-lg-12"
                                                            ...
                                                            <div class=" col-lg-5 flight_search_destination">
                                                                ...
                                                                <h3 class="bold"
                                                                    id="returnFromTIme{{ $loop->iteration }}">
                                                            ...
                                                            <div class=" col-lg-2 flight_search_middel">
                                                                <div class="flight_right_arrow">
                                                                    ...
                                                                    <p>{{ convertToHoursMins($fdataIn['totalDurationIn']) }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class=" col-lg-5 flight_search_destination">
                                                                ...
                                                                <h3 class="bold"
                                                                    id="returnToTIme{{ $loop->iteration }}">
                                                ...
                                                <div class="flight_search_right" style="display:flex;">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <h3 class="bold"><span
                                                                id="returnCurrency{{ $loop->iteration }}">{{ $totalFaresIn['CurrencyCode'] }}</span>
                                                            <!-- {{ $fdataIn['TotalFares']['TotalFare']['Amount'] }} -->
                                                            <span
                                                                id="returnAmount{{ $loop->iteration }}">{{ $totalFareMarginIn }}</span>
                                                            <!-- <sup>*20% OFF</sup> -->
                                                        </h3>

                                                        <input type="hidden" value="{{ $fdataIn['FareSourceCode'] }}"
                                                            name="fare_code_return{{ $loop->iteration }}"
                                                            id="fare_code_return{{ $loop->iteration }}">

                                                        <!-- <p>*Discount applicable on some conditions</p> -->
                                                        <h6 data-id="{{ $loop->iteration }}" data-type="return"
                                                            data-search_type="{{ $data['search_type'] }}"
                                                            data-session_id="{{ $data['session_id'] }}"
                                                            data-fareCode="{{ $fdataIn['FareSourceCode'] }}"
                                                            class="viewDomFlightDetails">View Details<i
                                                                class="fas fa-chevron-down"></i></h6>
                                                    </div>
                                                    <div class="col-lg-4" style="text-align: center;margin: auto;">
                                                        <input type="radio" class="bookIn"
                                                            value="{{ $loop->iteration }}"
                                                            @if ($loop->iteration == 1) checked @endif name="bookIn"
                                                            id="bookIn" class="col-form-control"
                                                            style="width: 25px;height: 25px;">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flight_policy_refund collapse"
                                                id="detialsDomReturnView_{{ $loop->iteration }}">
                            ...
                            <div class="d-flex stickyFlightDetails">
                                <div class="d-flex align-center margin-left-auto">
                                    ...
                                    <div class="d-flex align-center">
                                        <div>
                                            <a href="#" target="_blank" id="stickyButton"
                                                class="button bookingBtn btn-40 ">Book Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('footer')
    ...
    <script type="text/javascript">
        ...
        function getSelectedData() {
            ...
            $('#stickyDepFare').html($('#depCurrency' + departureFlight).html() + ' ' + $('#depAmount' + departureFlight)
                .html());
            ...
            $('#stickyReturnFare').html($('#returnCurrency' + returnFlight).html() + ' ' + $('#returnAmount' + returnFlight)
                .html());
            ...
            url = url + "?search_type=" + search_type + "&session_id=" + session_id + "&FareSourceCode=" + fare_code_dep +
                "&FareSourceCodeIn=" + fare_code_return;
