<div class="flight_search_item_wrappper" id="cont_{{ $loop->iteration }}" data-stops="{{ $fdata['stops'] }}"
    ...
    <div class="flight_search_items">
        ...
        <div class="flight_search_right">
            ...
            <button class="btn btn_theme btn_md  yas_ret_add_to_cart" data-fare="{{ $displayAmount }}"
                data-airline="{{ $fdata['airline'] }}" data-route="{{ $fdata['route'] }}"
                data-date_time="{{ $fdata['depature_date'] }}" data-flight_num="{{ $fdata['flight_no'] }}"
                data-rbd="{{ $fdata['rbd'] }}" data-rph="{{ $fdata['rph'] }}" data-loop_id="{{ $loop->iteration }}"
                data-api="yasin" data-search_id="{{ $data['search_id'] }}" data-flight_type="dep" type="button">Add To
                Cart</button>
        </div>
    </div>
