                                        ...
                                        <div class="row form_area">
                                            ...
                                            <div class="col-lg-4">
                                                <label for="date">Date Of Birth<span
                                                        class="required">*</span></label>
                                                <input type="text" class="form-control bg_input datepickerAdult"
                                                    readonly placeholder="YYYY-MM-DD" name="adult_dob[]"
                                    ...
                                    <div class="tour_booking_form_box mt-3">
                                        ...
                                        <div class="row form_area">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control appearance-auto"
                                                        name="infant_gender[]" id="infant_gender{{ $passCount }}">
                                                        <option value=""> Select</option>
                                                        <option value="male">Male</option>
                                                        <option value="female">Female</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-4">
                                                <label for="date">Date Of Birth<span
                                                        class="required">*</span></label>
                                                <input type="text" id="datepickerInfant{{ $passCount }}"
