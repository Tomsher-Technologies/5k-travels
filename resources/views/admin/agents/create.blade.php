        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Create New Agent <small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            @endif
                            <br />
                            <form id="storeAgent" action="{{ route('agent.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                @csrf
                                <div class="item form-group col-md-12 col-sm-12 ">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control" id="agent_type" name="agent_type" onchange="showAgents(this.value)">
                                            <option {{ (old('agent_type') == 'main') ? 'selected' : '' }} value="main">Agent</option>
                                            <option {{ (old('agent_type') == 'sub') ? 'selected' : '' }} value="sub">Sub Agent</option>
                                        </select>
                                        @error('agent_type')
                                ...
                                <div class="item form-group col-md-12 col-sm-12 {{ (old('agent_type') == 'sub') ? 'show' : 'hide' }}" id="agentsDiv">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="main_agent">Select Main Agent</label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control select2" name="main_agent" id="main_agent">
                                            @foreach($agents as $agent)
                                                <option {{ (old('main_agent') == $agent->id) ? 'selected' : '' }} value="{{ $agent->id }}">{{ $agent->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group col-md-12 col-sm-12 ">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="agent_code" name="agent_code" required="required" readonly class="form-control" value="{{ (old('agent_type') == 'sub') ? generateUniqueCode('sub_agent') : generateUniqueCode('agent') }}">
                                        @error('agent_code')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="item form-group col-md-12 col-sm-12 ">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="company_reg_no" name="company_reg_no"  class="form-control"  value="{{ old('company_reg_no') }}">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group col-md-12 col-sm-12 ">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="logo">Logo<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 ">
