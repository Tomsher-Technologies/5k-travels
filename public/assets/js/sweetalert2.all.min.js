...
!(function (e, t) {
    ...
    function de(e, t, n) {
        X(e, n[`show${a(t)}Button`], "inline-block"),
            q(e, n[`${t}ButtonText`]),
    ...
    const Ae = (e, t) => {
            ...
            N(o, t, "htmlContainer"),
                t.html
                    ? (re(t.html, o), Y(o, "block"))
                    : t.text
                    ? ((o.textContent = t.text), Y(o, "block"))
                    : Z(o),
                ((e, t) => {
                    const o = w(),
        ...
        xe = (e, t) => {
            if (t.iconColor) {
                ...
                for (const n of [
                    ...
                    J(e, n, "backgroundColor", t.iconColor);
    ...
    const tt = (e) => {
        ...
        it = (t, n, o, i, s) => {
            (e.swalCloseEventFinishedCallback = Xe.bind(null, t, o, i, s)),
                n.addEventListener(ce, function (t) {
                    t.target === n &&
    ...
    const ln = (e) => {
        for (let t = e.target; t && t !== document; t = t.parentNode)
            for (const e in an) {
                ...
                if (n) return void an[e].fire({ template: n });
            }
    };
    var cn = Object.freeze({
        ...
        bindClickHandler: function () {
            (an[
                ...
                rn || (document.body.addEventListener("click", ln), (rn = !0));
        },
    ...
    const dn = ["swal-title", "swal-html", "swal-footer"],
        ...
        kn = (e, t) => {
            ce && ee(t)
                ? ((e.style.overflowY = "hidden"), t.addEventListener(ce, An))
    ...
    const Ln = (t, o, i) =>
        ...
        Sn = (e, t) => {
            ...
            return (
                (o.showClass = Object.assign({}, Mt.showClass, o.showClass)),
                (o.hideClass = Object.assign({}, Mt.hideClass, o.hideClass)),
                o
            );
        },
        On = (e) => {
